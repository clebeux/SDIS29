...
<body>
	<div id="container">
	  ...
	  <div id="nav">
  		...
  		<div id="content">
    		<div id="left"> 
    			<form id="connexion" name="connexion" method="get" action="/assets/connexion/users-connect.php">
    				<div class="login">
				<div class="logg">
				...
				<div class="logd">
					...
					: <input type="text" id="login" name="login" value="<?php echo $_SESSION['login'];?>" size="10"> 
				<br><br>
