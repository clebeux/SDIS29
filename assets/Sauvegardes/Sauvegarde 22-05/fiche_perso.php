...
<hr/>
		...
		&nbsp;&nbsp;&nbsp;Matricule : 
		 <div class= "matricule">
		  ...
		  <?php 
                    ...
                    //$sql="select*,substring(convert(varchar(10),getdate()-datnaiss,103),9,10) from pompier WHERE SP_MATRICULE=$matricule;"
               ?>
         <br/>
	...
	<br/>
		...
		<div class="centre">
			<button onclick="location.href='formation.php'" class="boutonbip"><img class="centrer" width='32' height=32' src="/images/sac.jpg">Formation</img></button>
		</div>
